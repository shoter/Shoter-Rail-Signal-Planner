        ...
        {
          {
            ...
            icon                  = "__ShoterRailSignalPlanner__/graphics/icons/rail-signal-planner.png",
            icon_size             = 64,
            stack_size            = 1,
            stackable             = false,
            subgroup              = "tool",
          ...
          },
          {
            ...
            icon                     = "__ShoterRailSignalPlanner__/graphics/icons/rail-signal-shortcut.png",
            icon_size                = 32,
            small_icon               = "__ShoterRailSignalPlanner__/graphics/icons/rail-signal-shortcut.png",
            small_icon_size          = 32,
